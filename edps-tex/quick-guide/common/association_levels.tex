...
quality level (e.g., 24 hours), associated to the instrument calibration plan (labelled, for convention, as level=0).
...
\begin{itemize}
\item {\bf level $<$ 0}. Calibrations more restrictive than the calibration plan are selected.
\item {\bf level = 0}. Calibrations that follow the rules of the instrument calibration plans are selected.
\item {\bf level = 1}. The selected calibrations are sufficient to ensure good quality science results.
\item {\bf level = 2}. The selected calibrations "probably" produce results of still "acceptable" quality.
\item {\bf level = 3}. Significant risk of bad quality results or recipe failure.
