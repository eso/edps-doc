...
\begin{itemize}
\item level < 0. Calibrations more restrictive than the calibration plan are selected.
\end{itemize}
\begin{itemize}
\item level = 0. Calibrations that follow the rules of the instrument calibration plans are selected.
\end{itemize}
\begin{itemize}
\item level = 1. The selected calibrations are sufficient to ensure good quality science results.
\end{itemize}
\begin{itemize}
\item level = 2. The selected calibrations "probably" produce results of still "acceptable" quality.
\end{itemize}
\begin{itemize}
\item level = 3. Significant risk of bad quality results or recipe failure.
\end{itemize}
