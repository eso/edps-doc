...
2. In the Makefile and instrument_tutorial/Makefile
 ...
 Change GUI_VERSION and TUTORIAL_REVISION in  Makefile only
...
Usually, the list of files requiring changes are:
 ...
 configure_reduction.tex: describe the instrument specific parameters, and multiple reduction strategies
