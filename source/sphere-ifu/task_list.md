...
| ifs_distortion_map         | sph_ifs_distortion_map       | no                              | Measures geometric distortion via point-pattern comparison; outputs distortion map and optional residual map.     |
