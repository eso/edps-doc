...
# EFOS imaging workflow

## Reducing imaging data

Follow this procedure to quickly reduce EFOSC imaging demo data. We assume that the `EDPS` Graphic User Interface and the EFOSC
...
```{figure} figures/select_workflow_img.jpg
:alt: wkf_img
:name: fig-wkf_img

**The EFOSC imaging workflow selection procedure.**	
```
