...
For a detailed documentation on the SPHERE pipeline itself, consult the pipeline manual available [insert_link](https://ftp.eso.org/pub/dfs/pipelines/instruments/sphere/spher-pipeline-manual-1.58.pdf).
