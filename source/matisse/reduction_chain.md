# The MATISSE data reduction flow.

The overall data flow of the MATISSE pipeline is displayed [here](figures/reduction_cascade.jpg).
...
---
Go to MATISSE EDPS tutorial [index](../matisse/index)