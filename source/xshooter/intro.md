...
For a detailed documentation on the XSHOOTER pipeline itself, consult the pipeline manual available [insert_link](https://ftp.eso.org/pub/dfs/pipelines/instruments/xshooter/xshoo-pipeline-manual-3.8.3.pdf).
