...
|---------------------------------|------------------|-----------------------------------|--------------------------------------------------------------------------------|
| alignment	                      | muse_alignment	  | yes	                              | Aligns a set of exposures for combination using source list.                   |
| alignment_sky	                  | muse_alignment	  | no	                               | Aligns a set of sky exposures for combination using source list.               |
...
| source_detection                | muse_detection   | yes                               | Detects sources in the datacube and creates a source catalog.		                |
| source_detection_sky            | muse_detection   | no                                 | Detects sources in the datacube of sky exosure and creates a source catalog.		 |
